...
Dosh currently provides basic text editing capabilities, including character insertion, deletion, cursor movement, word navigation, tab insertion, and multiline editing.
